...
type LoaderData = {
  dispatchFields: CustomField[];
};

export const loader: LoaderFunction = async () => {
  const dispatchFields = await getCustomFields("dispatch");
  return json<LoaderData>({ dispatchFields });
};
...
export default function DispatchFields() {
  const { dispatchFields } = useLoaderData<LoaderData>();
  ...
  return (
    <div>
      <h2 className="text-2xl mb-4">Dispatch Fields</h2>
      {actionData?.error && (
